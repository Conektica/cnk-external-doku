...
2. Guardamos todas las imágenes en la misma carpeta y les cambiamos el nombre por el de su SKU, _por esta razón es importante tener una clave de identificación única para cada producto_, ya que las imágenes tomarán el nombre del producto para evitar confusiones y asegurar que los productos se suban correctamente.
...
<img src="https://conektica.com/ayuda/img/SubirCSV/csv13.png" width="75%"/>
...
<img src="https://conektica.com/ayuda/img/SubirCSV/csv14.png" width="100%"/>
...
<img src="https://conektica.com/ayuda/img/SubirCSV/csv15.png" width="70%"/>
